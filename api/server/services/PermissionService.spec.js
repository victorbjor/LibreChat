...
beforeEach(async () => {
  ...
  await AccessRole.create([
    ...
    {
      accessRoleId: ACCESS_ROLE_IDS.PROJECT_VIEWER,
      name: 'Project Viewer',
    ...
    {
      accessRoleId: ACCESS_ROLE_IDS.PROJECT_EDITOR,
      name: 'Project Editor',
    ...
    {
      accessRoleId: ACCESS_ROLE_IDS.PROJECT_MANAGER,
    ...
    {
      accessRoleId: ACCESS_ROLE_IDS.PROJECT_OWNER,
      name: 'Project Owner',
...
describe('PermissionService', () => {
  ...
  describe('grantPermission', () => {
    test('should grant permission to a user with a role', async () => {
      ...
      const role = await findRoleByIdentifier(ACCESS_ROLE_IDS.AGENT_VIEWER);
    ...
    test('should grant permission to a group with a role', async () => {
      ...
      // Get the role to verify the permission bits are correctly set
      const role = await findRoleByIdentifier(ACCESS_ROLE_IDS.AGENT_EDITOR);
      expect(entry.permBits).toBe(role.permBits);
      expect(entry.roleId.toString()).toBe(role._id.toString());
    });
    ...
    test('should throw error for role-resource type mismatch', async () => {
      await expect(
        grantPermission({
          ...
          resourceType: ResourceType.AGENT,
          resourceId,
          accessRoleId: ACCESS_ROLE_IDS.PROJECT_VIEWER, // Project role for agent resource
          grantedBy: grantedById,
        }),
    ...
    test('should update existing permission when granting to same principal and resource', async () => {
      ...
      const editorRole = await findRoleByIdentifier(ACCESS_ROLE_IDS.AGENT_EDITOR);
  ...
  describe('getEffectivePermissions', () => {
    beforeEach(async () => {
      ...
      await AclEntry.create({
        ...
        permBits: RoleBits.VIEWER,
        roleId: (await findRoleByIdentifier(ACCESS_ROLE_IDS.AGENT_VIEWER))._id,
        grantedBy: grantedById,
        grantedAt: new Date(),
  ...
  describe('getAvailableRoles', () => {
    test('should get all roles for a resource type', async () => {
      ...
      expect(roles.map((r) => r.accessRoleId).sort()).toEqual(
        [
          ACCESS_ROLE_IDS.AGENT_EDITOR,
          ACCESS_ROLE_IDS.AGENT_OWNER,
  ...
  describe('bulkUpdateResourcePermissions', () => {
    ...
    test('should update existing permissions in bulk', async () => {
      const updatedPrincipals = [
        {
          type: 'user',
          id: userId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_EDITOR, // Upgrade from viewer to editor
        },
        {
          type: 'group',
          id: groupId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_OWNER, // Upgrade from editor to owner
        },
        {
          type: 'public',
          accessRoleId: ACCESS_ROLE_IDS.AGENT_VIEWER, // Keep same role
        },
      ];
      ...
      expect(userEntry.roleId.accessRoleId).toBe(ACCESS_ROLE_IDS.AGENT_EDITOR);
      ...
      expect(groupEntry.roleId.accessRoleId).toBe(ACCESS_ROLE_IDS.AGENT_OWNER);
    });
    ...
    test('should handle mixed operations (grant, update, revoke)', async () => {
      const updatedPrincipals = [
        {
          type: 'user',
          id: userId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_OWNER, // Update existing
        },
        {
          type: 'user',
          id: otherUserId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_VIEWER, // New permission
        },
      ];
      ...
      expect(userEntry.roleId.accessRoleId).toBe(ACCESS_ROLE_IDS.AGENT_OWNER);

      const otherUserEntry = finalEntries.find(
        (e) => e.principalId.toString() === otherUserId.toString(),
      );
      expect(otherUserEntry.roleId.accessRoleId).toBe(ACCESS_ROLE_IDS.AGENT_VIEWER);
    });
      ...
      const updatedPrincipals = [
        {
          type: 'user',
          id: userId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_VIEWER, // Valid
        },
        {
          type: 'user',
          id: otherUserId,
        ...
        },
        {
          type: 'group',
          id: groupId,
          accessRoleId: ACCESS_ROLE_IDS.PROJECT_VIEWER, // Wrong resource type
        },
      ];
    ...
    test('should handle public permissions correctly', async () => {
      const updatedPrincipals = [
        {
          type: 'public',
          accessRoleId: ACCESS_ROLE_IDS.AGENT_EDITOR, // Update public permission
        },
        {
          type: 'user',
          id: otherUserId,
          accessRoleId: ACCESS_ROLE_IDS.AGENT_VIEWER, // New user permission
        },
      ];
      ...
      expect(publicEntry.roleId.accessRoleId).toBe(ACCESS_ROLE_IDS.AGENT_EDITOR);
    });
